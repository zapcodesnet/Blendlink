...
# Commission rates from 10% platform fee distributed to uplines (L1/L2)
...
SUBSCRIPTION_TIERS = {
    "free": {
        ...
        "monthly_transactions_limit": 100,
        "exclusive_badges": [],
    ...
    "silver": {
        ...
        "monthly_transactions_limit": 2_000,
        ...
        "features": [
            ...
            "2,000 sales transactions per month",
            "3% L1 / 2% L2 commissions"
        ]
    },
    "gold": {
...
LEGACY_TIER_MAP = {
    "basic": "bronze",
    "premium": "silver",
    "platinum": "diamond",  # Map old platinum to new diamond
}
